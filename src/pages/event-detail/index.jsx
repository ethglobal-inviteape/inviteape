    ...
    <div className="mx-auto flex max-w-screen-lg flex-col pt-10">
      <div className="flex flex-col items-center pb-12 md:border-b-0 md:pb-0">
        ...
        <section className="mb-3">
          <div className="flex flex-col py-2 px-4 text-[#FFFFFF] bg-[#0E0E0E] rounded-lg opacity-75">
        ...
        <section className="mb-3">
          <div className="mx-auto flex flex-col py-2 px-4 text-[#FFFFFF] bg-[#0E0E0E] rounded-lg">
            <div className="flex flex-col item-center">
              ...
              <div
                className="mb-6 flex w-[250px] h-[68px] flex-row items-center
                justify-center rounded-lg bg-green-600 py-2
                text-white mx-auto text-[24px] border-[#09FF3F] border-2">Share on Lens
              </div>
            </div>
